      ...
      >
        <div className="grid grid-count-6">
          ...
          <div className="grid-col">
            <span className="text-overflow-ellipsis">{product.pname || <Skeleton width={30} />}</span>
          </div>
          <div className="grid-col">
            <span>{product.description || <Skeleton width={50} />}</span>
          </div>
          <div className="grid-col">
            <span>{product.price ? displayMoney(product.price) : <Skeleton width={30} />}</span>
          </div>
          <div className="grid-col">
            <span>{product.stock || <Skeleton width={20} />}</span>
          </div>
          <div className="grid-col">
